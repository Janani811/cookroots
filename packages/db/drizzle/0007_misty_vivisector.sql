CREATE TYPE "public"."reaction_target_type" AS ENUM('comment', 'recipe_description');--> statement-breakpoint
ALTER TYPE "public"."notification_type" ADD VALUE 'reply' BEFORE 'rating';--> statement-breakpoint
...
CREATE TABLE "reactions" (
	...
	"emoji" text NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "reactions_target_type_target_id_user_id_emoji_unique" UNIQUE("target_type","target_id","user_id","emoji")
);
--> statement-breakpoint
ALTER TABLE "recipe_comments" ADD COLUMN "parent_comment_id" uuid;--> statement-breakpoint
